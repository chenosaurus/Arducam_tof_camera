...
function SOArm100Robot({ videoElement, hasActiveVideoTrack, jointAngles }: {
...
function StatusIndicators() {
    return (
        <group position={[-4, 20, 0]}>
            ...
            <Text
                position={[0, 1, 0.01]} // slightly in front of card
                fontSize={1.5}
                color="#00ff00"
                anchorX="left"
                anchorY="middle"
...
export function RobotArm3D({ videoElement, hasActiveVideoTrack = false, jointAngles }: {
    videoElement?: HTMLVideoElement | null;
    hasActiveVideoTrack?: boolean;
    jointAngles?: JointAngles;
} = {}) {
